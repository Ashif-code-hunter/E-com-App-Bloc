...
class ProductModel extends Product {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
        ...
        priceTags: List<PriceTagModel>.from(json["priceTags"].map((x) => PriceTagModel.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "name": name,
        "description": description,
        "priceTags": List<dynamic>.from((priceTags as List<PriceTagModel>).map((x) => x.toJson())),
